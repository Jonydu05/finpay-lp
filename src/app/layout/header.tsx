'use client';
import { CactusIcon, MoonIcon, SunIcon } from '@phosphor-icons/react';
...
export default function Header() {
  ...
  return (
    <header className="layout sticky top-0 z-50 bg-background bg-linear-180 bg-fixed">
      <div className="container flex justify-between gap-4 items-center p-4">
        <a
          href="#home"
          className="flex gap-2 items-center font-extrabold text-2xl font-serif"
        >
          <CactusIcon size={36} weight="fill" />
          <span className="font-serif text-3xl font-semibold">Finpay</span>
        </a>
        <nav>
